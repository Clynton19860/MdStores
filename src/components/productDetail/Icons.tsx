...
export function StarIcon({ className = "w-6 h-6", filled = false, halfFilled = false }: StarIconProps) {
  if (filled) {
    return (
      <svg
    ...
    return (
      ...
      >
        <defs>
          <linearGradient id="half-filled-star" x1="0" x2="1" y1="0" y2="0">
...
export function ShippingIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
